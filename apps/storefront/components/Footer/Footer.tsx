      ...
      <div className={styles["footer-inner"]}>
        <div className="flex mb-10 flex-wrap">
          <div className="order-last sm:order-none">
            ...
            <div className="text-main-2 flex gap-2 my-4">
              <a href="https://www.facebook.com/profile.php?id=100083079956268">
                <svg
              ...
              <a href="https://instagram.com/kuuzamart">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <a href="https://twitter.com/kuuzamart">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="w-6 h-6"
            ...
            <a href="tel:+256700550197" className="block text-md text-main-2 my-4">
              +256-700-550197
            </a>
            <a href="mailto:kuuzamart@gmail.com" className="block text-md text-main-2 my-4">
              kuuzamart@gmail.com
            </a>
          </div>
